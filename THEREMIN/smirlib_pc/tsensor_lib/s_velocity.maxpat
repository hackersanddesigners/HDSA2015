...
,
		"rect" : [ 39.0, 195.0, 318.0, 438.0 ],
		"bglocked" : 0,
		"defrect" : [ 39.0, 195.0, 318.0, 438.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 132.0, 330.0, 15.0, 15.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"id" : "obj-2",
					"comment" : ""
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "> 3.",
					"patching_rect" : [ 132.0, 273.0, 27.0, 17.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 94.0, 143.0, 15.0, 15.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"id" : "obj-13"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "- 0.",
					"patching_rect" : [ 75.0, 163.0, 54.0, 17.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pipe 0. 30",
					"patching_rect" : [ 110.0, 122.0, 52.0, 17.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 132.0, 298.0, 26.0, 17.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
