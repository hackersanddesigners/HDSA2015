...
class DCCSend(irc.client.SimpleIRCClient):
    ...
    def on_welcome(self, connection, event):
        ...
        print "localaddress", self.dcc.localaddress, self.dcc.localport
        # print "peer", self.dcc.peeraddress
        print self.dcc, dir(self.dcc)
        DCC = "SEND %s %s %d %d" % (
            ...
            self.filesize)
        print "DCC", DCC
        self.connection.ctcp("DCC", self.receiver, DCC)
